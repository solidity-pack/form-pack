<?php
class TokenERC20 {
	function basic($nameToken, $symbolToken, $supplyToken, $decimalsToken) {
		$compare = "pragma solidity >=0.4.22 <0.6.0; //Use the recommended version is v0.5.1+commit.c8a2cb62
...
contract TokenERC20 is ERC20, ERC20Detailed {
    uint private INITIAL_SUPPLY = ".$supplyToken."e".$decimalsToken.";
    constructor () public
    ERC20Detailed('".$nameToken."', '".$symbolToken."', ".$decimalsToken.") {
